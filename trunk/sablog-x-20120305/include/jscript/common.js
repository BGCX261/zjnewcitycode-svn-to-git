...
var is_firefox = document.getBoxObjectFor && userAgent.indexOf('firefox') != -1 && userAgent.substr(userAgent.indexOf('firefox') + 8, 3);
var is_chrome = window.MessageEvent && !document.getBoxObjectFor && userAgent.indexOf('chrome') != -1 && userAgent.substr(userAgent.indexOf('chrome') + 7, 10);
var is_opera = window.opera && opera.version();
var is_safari = window.openDatabase && userAgent.indexOf('safari') != -1 && userAgent.substr(userAgent.indexOf('safari') + 7, 8);
var is_other = !is_ie && !is_firefox && !is_chrome && !is_opera && !is_safari;
...
function updateseccode() {
	...
	$("#seccodeimage").html('<img id="seccode" onclick="updateseccode()" src="' + blogurl + 'seccode.php?update=' + rand + '" class="codeimg" alt="单击图片换个验证码" />');
}
